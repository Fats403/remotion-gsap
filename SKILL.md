...
Use GSAP labels and position parameters instead of manually calculating many frame ranges. Use nested timelines when a group has reusable internal choreography.
...
- Never use unseeded randomness. Derive stable values from data or Remotion's seeded `random()`.
