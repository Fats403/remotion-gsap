...
export const GsapShowcase = () => {
  const scope = useGsapTimeline<HTMLDivElement>(({timeline, selector}) => {
    ...
    timeline
      ...
      .to(selector('[data-orbit]'), {rotation: 360, duration: 5.4, ease: 'none'}, 0)
      .to(
        selector('[data-glow]'),
      ...
      .fromTo(
        selector('[data-wipe]'),
        {scaleX: 0},
        {scaleX: 1, duration: 0.7, transformOrigin: '0% 50%', ease: 'expo.inOut'},
        'outro+=0.35',
      )
      .from(
        selector('[data-final]'),
    ...
    >
      <div data-stage style={{position: 'absolute', inset: 0, opacity: 0}}>
        ...
        <div style={{position: 'absolute', inset: '62px 74px'}}>
          ...
          <div data-rule style={{width: 600, height: 4, marginTop: 22, background: '#B8FF5A'}} />
        ...
        <div
          data-wipe
          style={{position: 'absolute', inset: 0, background: '#B8FF5A', transform: 'scaleX(0)'}}
        />
        <div
          data-final
          style={{
        ...
        >
          ...
          <div style={{fontSize: 82, fontWeight: 900, letterSpacing: '-0.06em', marginTop: 8}}>
